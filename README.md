...
- check if latest Firmware on CapsLoc Cube, if not upload new [Firmware](https://www.dropbox.com/sh/hpzjsknbeh27m02/AABas8TiwU8v1n-aVvwHaHc6a?dl=0) (connect to CapsLoc WiFi, CapsLocIP:8080/update)
...
### Hololens Map Demo (04_Hololens_Map)
